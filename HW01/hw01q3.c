...
// CSE 240 Spring 2023 Homework 1 Question 3 (20 points)
...
int main(){
	...
	// Problem 2: (4 points)
	// You want that half of 50 to be 25, why is the program printing that half of 50 is 0? Correct the error(s) (2 points).
	...
	printf("Error Type: Contextual \n\n");
     ...
     //Problem 3    (2 points)
     //Integer variable y is initialized to 100 and its integer value needs to be printed. Correct the error(s).(1 point)
   int y = 100;
   printf("y is %d\n",y); 
	...
	printf("Error Type: Contextual \n\n");
     ...
     printf("The type of value that y is did not fit with what the print statement was looking for. This is a contextual error. \n\n");
